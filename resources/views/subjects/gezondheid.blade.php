...
<div class="sidenav" id="menuToggle">
    ...
    <div class="onderwerp__onderwerp">
        ...
        <div class="blok__onderwerp">
            <h3>Huisdokter</h3>
            <p>Je huisdokter is je vaste dokter als je ziek bent ga je hier langs. In het weekend kan je gebruik maken van de artsen wachtpost voor dingen die niet tot na het weekend kunnen wachten.
            </p>
        </div>
        <div class="blok__onderwerp">
            <h3>Tandarts</h3>

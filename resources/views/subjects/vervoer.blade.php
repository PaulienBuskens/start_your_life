    ...
    <div class="row justify-content-center">
       <div class="col-md-12 col-md-offset-2">
            <div class="text-center">
                ...
                <div class="blokimg">
                    <img src="{{ asset('images/vervoer/car.png')}}" alt="">
                </div>
                <div class="blokimg2">
                    <img src="{{ asset('images/vervoer/bike.png')}}" alt="">
                </div>
                <div class="blok2">
                    <h3>Fiets</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                <div class="blokimg">
                    <img src="{{ asset('images/vervoer/public-transportation.png')}}" alt="">
                </div>
                <div class="blokimg2">
                    <img src="{{ asset('images/vervoer/motorcycle.png')}}" alt="">
                </div>
                <div class="blok2">
                    <h3>Motor</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
